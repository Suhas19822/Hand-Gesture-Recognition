...
training_files = [
    "/content/drive/MyDrive/Gestures/a1_va3.csv",
    "/content/drive/MyDrive/Gestures/b1_va3.csv",
    "/content/drive/MyDrive/Gestures/b3_va3.csv",
    "/content/drive/MyDrive/Gestures/c1_va3.csv",
    "/content/drive/MyDrive/Gestures/c3_va3.csv",
    "/content/drive/MyDrive/Gestures/a2_va3.csv",
    "/content/drive/MyDrive/Gestures/a3_va3.csv",
]
...
class GestureModel:
    ...
    def __init__(self,model_type,model_size,learning_rate = 0.001):
        ...
        head = self.x
        if(model_type == "lstm"):
            self.fused_cell = tf.compat.v1.rnn_cell.LSTMCell(model_size)
...
model = GestureModel(model_type = "ltc",model_size=32) #Select model of your choice - lstm,ctrnn,ltc

model.fit(gesture_data,epochs=200,log_period=1)
